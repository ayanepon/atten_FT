...
DEFAULT_RUN_DIR = "models/mimir_wikipedia_hardsplit_lora_ft_lr1e-4_epoch5_pythia69b"
DEFAULT_OUTPUT_DIR = "results/attenmia_official_mimir_hardsplit_pythia69b"
SEED = 42
EPS = 1e-12
